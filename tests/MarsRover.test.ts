...
describe('MarsRover', () => {
    ...
    describe('executeCommands', () => {
        it('should execute commands correctly', () => {
          ...
          const rover = new MarsRover(1, 2, 'N', plateau);
    ...
    it('should move forward correctly when facing South', () => {
      const rover = new MarsRover(0, 0, 'S', plateau);
    ...
    it('should move forward correctly when facing West', () => {
      const rover = new MarsRover(0, 0, 'W', plateau);
    ...
    it('should move forward correctly when facing East', () => {
      const rover = new MarsRover(0, 0, 'E', plateau);
